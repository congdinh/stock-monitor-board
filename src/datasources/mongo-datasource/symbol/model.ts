...
import { ISymbol, IFilterQuery } from '../../../common/interface';
...
export default class ModelDataSource extends MongoDataSource {
  ...
  async create(input: ISymbol, ttl: number) {
  ...
  async update({ _id, ...info }: ISymbol, ttl: number) {
