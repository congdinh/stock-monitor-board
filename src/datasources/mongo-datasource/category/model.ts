...
import { ICategory, IFilterQuery } from '../../../common/interface';
...
export default class ModelDataSource extends MongoDataSource {
  ...
  async create(input: ICategory, ttl: number) {
  ...
  async update({ _id, ...info }: ICategory, ttl: number) {
